# Evidence: WF-09 Payment to Supplier

> **Companion:** [../WF-09-payment-to-supplier.md](../WF-09-payment-to-supplier.md)  
...
|------|--------|-----------|
| Flow trace | `output/cursor/08 P2P payment` | Main code path |
| Routes | `output/cursor/03-route-api-inventory.md` | Entry URLs |
| Module | `output/cursor/02-module-inventory.md` | Actions & services |
| Workflow doc | `output/cursor/workflows/WF-09-payment-to-supplier.md` | Use case narrative |
...
|-------|----------------|------------|
| Entry | `ClosePaymentAction.java` | INFERRED / WF_CONFIRMED |
| Service | `PaymentSlipService` | WF_CONFIRMED |
| Tables | `PAYMENT_SLIP_TRN, APT_BALANCE_TRN` | SQL_CONFIRMED / DDL_CONFIRMED |
