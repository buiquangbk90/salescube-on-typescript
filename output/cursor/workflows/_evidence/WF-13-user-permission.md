# Evidence: WF-13 User & Permission

> **Companion:** [../WF-13-user-permission.md](../WF-13-user-permission.md)  
...
|------|--------|-----------|
| Flow trace | `output/cursor/06-auth-permission-analysis.md` | Main code path |
| Routes | `output/cursor/03-route-api-inventory.md` | Entry URLs |
| Module | `output/cursor/02-module-inventory.md` | Actions & services |
| Workflow doc | `output/cursor/workflows/WF-13-user-permission.md` | Use case narrative |
...
|-------|----------------|------------|
| Entry | `EditUserAction.java` | INFERRED / WF_CONFIRMED |
| Service | `UserService, RoleService` | WF_CONFIRMED |
| Tables | `USER_MST, GRANT_ROLE` | SQL_CONFIRMED / DDL_CONFIRMED |
