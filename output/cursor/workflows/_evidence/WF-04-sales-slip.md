# Evidence: WF-04 Sales Slip Entry

> **Companion:** [../WF-04-sales-slip.md](../WF-04-sales-slip.md)  
...
|------|--------|-----------|
| Flow trace | `output/cursor/08-business-flow-hypotheses.md §4` | Main code path |
| Routes | `output/cursor/03-route-api-inventory.md` | Entry URLs |
| Module | `output/cursor/02-module-inventory.md` | Actions & services |
| Workflow doc | `output/cursor/workflows/WF-04-sales-slip.md` | Use case narrative |
...
|-------|----------------|------------|
| Entry | `InputSalesAction.java` | INFERRED / WF_CONFIRMED |
| Service | `SalesService, EadService` | WF_CONFIRMED |
| Tables | `SALES_SLIP_TRN, PRODUCT_STOCK_TRN` | SQL_CONFIRMED / DDL_CONFIRMED |
