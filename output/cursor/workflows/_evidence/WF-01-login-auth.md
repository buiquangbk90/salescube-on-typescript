# Evidence: WF-01 Login & Authentication

> **Companion:** [../WF-01-login-auth.md](../WF-01-login-auth.md)  
...
|------|--------|-----------|
| Flow trace | `output/cursor/08-business-flow-hypotheses.md §3` | Main code path |
| Routes | `output/cursor/03-route-api-inventory.md` | Entry URLs |
| Module | `output/cursor/02-module-inventory.md` | Actions & services |
| Workflow doc | `output/cursor/workflows/WF-01-login-auth.md` | Use case narrative |
...
|-------|----------------|------------|
| Entry | `LoginAction.java` | INFERRED / WF_CONFIRMED |
| Service | `UserService, DomainService, MenuService` | WF_CONFIRMED |
| Tables | `USER_MST, GRANT_ROLE, MENU_MST` | SQL_CONFIRMED / DDL_CONFIRMED |
