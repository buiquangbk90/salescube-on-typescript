# Evidence: WF-05 Bill Closing

> **Companion:** [../WF-05-bill-closing.md](../WF-05-bill-closing.md)  
...
|------|--------|-----------|
| Flow trace | `output/cursor/08 O2C bill section` | Main code path |
| Routes | `output/cursor/03-route-api-inventory.md` | Entry URLs |
| Module | `output/cursor/02-module-inventory.md` | Actions & services |
| Workflow doc | `output/cursor/workflows/WF-05-bill-closing.md` | Use case narrative |
...
|-------|----------------|------------|
| Entry | `CloseBillAction.java` | INFERRED / WF_CONFIRMED |
| Service | `BillService, BillAndArtService` | WF_CONFIRMED |
| Tables | `BILL_TRN, SALES_SLIP_TRN, ART_BALANCE_TRN` | SQL_CONFIRMED / DDL_CONFIRMED |
