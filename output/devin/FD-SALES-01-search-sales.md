...
**Evidence**: `Confirmed by code` — `action/sales/InputSalesAction.java:1-65`  
**Evidence**: `Confirmed by code` — `service/SalesService.java`
...
**Evidence**: `Confirmed by code` — WF-04 Status Transitions
...
|----|---------|--------|------------|
| OQ-SALES-05 | Có filter theo roSlipId (xem sales từ RO cụ thể) không? | LOW | `Unknown / needs verification` |
| OQ-SALES-06 | Export danh sách ra CSV? | LOW | `Unknown / needs verification` |
