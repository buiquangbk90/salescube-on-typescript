...
output/                      RE docs (AGENT.md)
output/workflows/            WF-XX (+ _inventory, _evidence, _reports)
...
|------|--------------|--------------|
| `/reverse-engineering-java` | `reverse-engineering-java.md` | 0–11: scope, routes, dependency graph |
| `/generate-workflow-docs` | `generate-workflow-docs.md` | 0–7: route inventory → WF-XX |
